...
func registerSDKWords(r *eng.Registry, client *sdk.WeltNewsSDK) {
...
func runOp(client *sdk.WeltNewsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {

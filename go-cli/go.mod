module github.com/voxgig-sdk/welt-news-sdk/go-cli

go 1.24.7

require github.com/voxgig-sdk/welt-news-sdk/go v0.0.0
...
replace github.com/voxgig-sdk/welt-news-sdk/go => ../go

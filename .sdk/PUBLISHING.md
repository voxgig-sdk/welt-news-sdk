...
|---|---|---|
| `ts/` | @voxgig-sdk/welt-news-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/welt-news-sdk \
      --repository voxgig-sdk/welt-news-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/welt-news-sdk` shows it, and
`npm trust revoke @voxgig-sdk/welt-news-sdk --id=<id>` removes it.

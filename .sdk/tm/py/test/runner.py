...
class WeltNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeltNewsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = WeltNewsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = WeltNewsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")

...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = WeltNewsOmni.make_runner(TEST_JSON_FILE, WeltNewsSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : WeltNewsOmni.errify(err)
    end

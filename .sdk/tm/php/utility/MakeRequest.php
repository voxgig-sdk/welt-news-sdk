...
// WeltNews SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class WeltNewsMakeRequest
{
    public static function call(WeltNewsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new WeltNewsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new WeltNewsResponse($fetched);
        } else {

...
// WeltNews SDK ratelimit feature
...
class WeltNewsRatelimitFeature extends WeltNewsBaseFeature
{
    ...
    private function _acquire(WeltNewsContext $ctx): void
    {
    ...
    private function _track(WeltNewsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;

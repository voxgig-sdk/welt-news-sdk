...
// WeltNews SDK streaming feature
...
class WeltNewsStreamingFeature extends WeltNewsBaseFeature
{
    ...
    private function _iterate(WeltNewsResult $result): \Generator
    {
    ...
    private function _streamable(WeltNewsContext $ctx): bool
    {

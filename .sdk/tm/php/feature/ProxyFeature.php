...
class WeltNewsProxyFeature extends WeltNewsBaseFeature
{
    ...
    public function init(WeltNewsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (WeltNewsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {

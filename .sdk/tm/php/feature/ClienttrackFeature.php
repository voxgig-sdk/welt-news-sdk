...
// WeltNews SDK clienttrack feature
...
class WeltNewsClienttrackFeature extends WeltNewsBaseFeature
{
    ...
    public function PostConstruct(WeltNewsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'WeltNews-SDK';

...
class WeltNewsNetsimFeature extends WeltNewsBaseFeature
{
    ...
    private function _simulate(WeltNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(WeltNewsContext $ctx, array $applied): void
    {
        $client = $this->client;

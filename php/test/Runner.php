...
class WeltNewsTestRunner
{
    ...
    {
        $live = self::getenv('WELT_NEWS_TEST_LIVE');
        $override = self::getenv('WELT_NEWS_TEST_OVERRIDE');
        ...
        $explain = self::getenv('WELT_NEWS_TEST_EXPLAIN');
...
class_alias('WeltNewsTestRunner', 'Runner');
class_alias('WeltNewsHelpers', 'Helpers');

...
// WeltNews SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = WeltNewsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(WeltNewsOmni::structfix($now, Struct::undef()))
                        !== json_encode(WeltNewsOmni::structfix($val, Struct::undef()))) {

...
// WeltNews SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (WeltNewsSDK::test)
...
{
    private const SDK_CLASS = 'WeltNewsSDK';
    ...
    private const SDK_BASE = 'weltnews_sdk';

...
// WeltNews SDK utility: fetcher

class WeltNewsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; WeltNewsSDK/1.0)';
    ...
    public static function call(WeltNewsContext $ctx, string $fullurl, array $fetchdef): array
    {

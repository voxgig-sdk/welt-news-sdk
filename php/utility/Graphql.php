...
class WeltNewsGraphql
{
    ...
    // equivalent.
    public static function body(WeltNewsContext $ctx): mixed
    {
    ...
    public static function errors(WeltNewsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;

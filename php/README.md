...
The PHP SDK for the WeltNews API — an entity-oriented client using PHP conventions.
...
```php
<?php
require_once 'weltnews_sdk.php';

$client = new WeltNewsSDK();
```
...
```php
require_once 'weltnews_sdk.php';
$client = new WeltNewsSDK($options);
```
...
The main class (`weltnews_sdk.php`) exports the SDK class

...
class WeltNewsTimeoutFeature extends WeltNewsBaseFeature
{
    ...
    private function _with_timeout(WeltNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(WeltNewsContext $_ctx, float $ms): void
    {
        $client = $this->client;

...
class WeltNewsCacheFeature extends WeltNewsBaseFeature
{
    ...
    private function _through(WeltNewsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {

...
class WeltNewsRbacFeature extends WeltNewsBaseFeature
{
    ...
    private function _required(WeltNewsContext $ctx): ?string
    {
    ...
    private function _reject(WeltNewsContext $ctx, string $required): void
    {
    ...
    private function _track(WeltNewsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;

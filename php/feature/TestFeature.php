...
// WeltNews SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class WeltNewsTestFeature extends WeltNewsBaseFeature
{
    ...
    public function init(WeltNewsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (WeltNewsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (WeltNewsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(WeltNewsContext $ctx, $op, $args): array
    {

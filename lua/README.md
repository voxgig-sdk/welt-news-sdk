...
The Lua SDK for the WeltNews API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/welt-news-sdk/releases)),
...
The main module (`welt-news_sdk`) exports the SDK constructor

...
function liveScenariosActive() { return false && process.env.WELT_NEWS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.WeltNewsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['WELT_NEWS_TEST_ARTICLE_ENTID'];
    ...
    const client = new __1.WeltNewsSDK({
        base: 'http://localhost:8080',

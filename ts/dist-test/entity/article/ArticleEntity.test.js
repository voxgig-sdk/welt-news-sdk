...
(0, node_test_1.describe)('ArticleEntity', async () => {
    ...
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('WELT_NEWS_TEST_LIVE'));
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.WeltNewsSDK.test();
...
function basicSetup(extra) {
    ...
    let client = __1.WeltNewsSDK.test(options, extra);
    ...
    if (live) {
        ...
        client = new __1.WeltNewsSDK(merge([

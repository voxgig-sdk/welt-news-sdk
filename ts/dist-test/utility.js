...
function envOverride(m) {
    if ('TRUE' === process.env.WELT_NEWS_TEST_LIVE ||
        'TRUE' === process.env.WELT_NEWS_TEST_OVERRIDE) {
    ...
    m.WELT_NEWS_TEST_EXPLAIN = process.env.WELT_NEWS_TEST_EXPLAIN || m.WELT_NEWS_TEST_EXPLAIN;
    return m;
}

...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.WELTNEWS_TEST_LIVE ||
    'TRUE' === process.env.WELTNEWS_TEST_OVERRIDE
  ) {
  ...
  m.WELTNEWS_TEST_EXPLAIN = process.env.WELTNEWS_TEST_EXPLAIN || m.WELTNEWS_TEST_EXPLAIN

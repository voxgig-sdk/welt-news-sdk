...
Welt News API client, generated from the OpenAPI spec.

The Welt News API provides access to live news articles, comments, live ticker updates, videos, and streams from welt.de.

Learn more about Welt News API at [welt.de](https://welt.de).

This is an unofficial SDK for the Welt News public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — Article — that you
...
```bash
cd go-mcp && go build -o welt-news-mcp .
```
...
```json
{
  "mcpServers": {
    "welt-news": {
      "command": "/abs/path/to/welt-news-mcp"
    }
  }
}
```
...
| --- | --- | --- |
| **Article** | The Article entity (list). | `/articles/home` |
...
```go
import sdk "github.com/voxgig-sdk/welt-news-sdk/go"
...
- Upstream API: [https://github.com/l0v3m0n3y/welt](https://github.com/l0v3m0n3y/welt)
...
Generated from the Welt News API OpenAPI spec by [@voxgig/sdkgen](https://github.com/voxgig/sdkgen).

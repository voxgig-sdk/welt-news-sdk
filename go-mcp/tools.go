...
type Args struct {
	Entity string         `json:"entity" jsonschema:"article"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.WeltNewsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "welt-news_list",
		Description: "List records from WeltNews. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "welt-news_load",
		Description: "Load a single record from WeltNews. " +
...
func runOp(client *sdk.WeltNewsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.WeltNewsSDK, name string) (sdk.WeltNewsEntity, error) {

...
The Python SDK for the WeltNews API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/welt-news-sdk/releases)) or
...
```python
client = WeltNewsSDK.test(testopts, sdkopts)
```
...
The main module (`weltnews_sdk`) exports the SDK class.

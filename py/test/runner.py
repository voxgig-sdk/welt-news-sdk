...
class WeltNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeltNewsTestRunner.getenv("WELTNEWS_TEST_LIVE")
        override = WeltNewsTestRunner.getenv("WELTNEWS_TEST_OVERRIDE")
        ...
        explain = WeltNewsTestRunner.getenv("WELTNEWS_TEST_EXPLAIN")

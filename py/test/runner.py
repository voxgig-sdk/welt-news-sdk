...
class WeltNewsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = WeltNewsTestRunner.getenv("WELT_NEWS_TEST_LIVE")
        override = WeltNewsTestRunner.getenv("WELT_NEWS_TEST_OVERRIDE")
        ...
        explain = WeltNewsTestRunner.getenv("WELT_NEWS_TEST_EXPLAIN")

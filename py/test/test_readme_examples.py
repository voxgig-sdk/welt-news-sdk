# WeltNews SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions WeltNewsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both WeltNewsSDK(...) and WeltNewsSDK.test(...) become
#      WeltNewsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "weltnews_sdk"
_SDK_CLASS = "WeltNewsSDK"

...
from weltnews_sdk.core.spec import WeltNewsSpec
from weltnews_sdk.core.result import WeltNewsResult
from weltnews_sdk.core.response import WeltNewsResponse
from weltnews_sdk.core.operation import WeltNewsOperation
from weltnews_sdk.core.error import WeltNewsError
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = WeltNewsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = WeltNewsSDK.test(None, None)
        ...
        class TestInitFeature(WeltNewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(WeltNewsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = WeltNewsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = WeltNewsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = WeltNewsSDK.test(None, setup_opts)

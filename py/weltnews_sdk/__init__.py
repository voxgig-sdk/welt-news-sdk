...
from weltnews_sdk.utility import register

# Load features
from weltnews_sdk.feature.base_feature import WeltNewsBaseFeature
from weltnews_sdk.features import _has_feature, _make_feature
...
class WeltNewsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = WeltNewsUtility()
        self._utility = utility

        from weltnews_sdk.config import shared_config
    ...
    def get_utility(self):
        return WeltNewsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("WeltNewsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Article(self, data=None) -> "ArticleEntity":
        ...
        from weltnews_sdk.entity.article_entity import ArticleEntity
        return ArticleEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "WeltNewsSDK":
        if sdkopts is None:
            sdkopts = {}
